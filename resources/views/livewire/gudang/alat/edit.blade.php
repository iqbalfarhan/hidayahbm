<div>
    <div wire:ignore.self class="modal fade" tabindex="-1" role="modal" id="editAlat">
                ...
                <form wire:submit.prevent="submit">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" disabled class="form-control @error('kode') is-invalid @enderror" id="kode" placeholder="" value="{{ $kode }}">
                            @if($errors->has('kode'))
